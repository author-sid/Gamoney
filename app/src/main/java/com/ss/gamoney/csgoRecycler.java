...
public class csgoRecycler extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        switch (menuitem.getItemId()) {
            ...
            case R.id.nav_Logout:
                AlertDialog.Builder builder = new AlertDialog.Builder(csgoRecycler.this);
            ...
            case R.id.nav_Resetpassword:
                ...
                AlertDialog.Builder resetpassword = new AlertDialog.Builder(csgoRecycler.this);
                        ...
                        if (mail.matches("")) {
                            ...
                            mAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(csgoRecycler.this, "Reset Link Sent to Your Email", Toast.LENGTH_SHORT).show();
                                    FirebaseAuth.getInstance().signOut();
                                    startActivity(new Intent(getApplicationContext(), LoginActivity.class));
                                    finish();
                                }
